...
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siamrpn_r50_l234_dwxcorr_otb\\trans_over',
#                     type=str, help='tracker name')
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siamrpn_r50_l234_dwxcorr_lt\\trans_over',
#                     type=str, help='tracker name')
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siamrpn_mobilev2_l234_dwxcorr\\trans_over',
#                     type=str, help='tracker name')
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siamrpn_alex_dwxcorr\\trans_over',
#                     type=str, help='tracker name')
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siammask_r50_l3\\trans_over',
#                     type=str, help='tracker name')
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siamcar_r50\\trans_over',
#                     type=str, help='tracker name')
# parser.add_argument('--tracker_prefix', '-t', default='experiments\\siamnca_r50\\trans_over',
#                     type=str, help='tracker name')
