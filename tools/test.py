...
# parser.add_argument('--config', default='experiments\\siamrpn_r50_l234_dwxcorr_lt\\config.yaml', type=str,
#         help='config file')
# parser.add_argument('--snapshot', default='experiments\\siamrpn_r50_l234_dwxcorr_lt\\trans_over.pdparams', type=str,
#         help='snapshot of models to eval')
# parser.add_argument('--config', default='experiments\\siamrpn_mobilev2_l234_dwxcorr\\config.yaml', type=str,
#         help='config file')
# parser.add_argument('--snapshot', default='experiments\\siamrpn_mobilev2_l234_dwxcorr\\trans_over.pdparams', type=str,
#         help='snapshot of models to eval')
...
#         help='snapshot of models to eval')
# parser.add_argument('--config', default='experiments\\siamrpn_alex_dwxcorr\\config.yaml', type=str,
#         help='config file')
# parser.add_argument('--snapshot', default='experiments\\siamrpn_alex_dwxcorr\\trans_over.pdparams', type=str,
#         help='snapshot of models to eval')
# parser.add_argument('--config', default='experiments\\siammask_r50_l3\\config.yaml', type=str,
#         help='config file')
# parser.add_argument('--snapshot', default='experiments\\siammask_r50_l3\\trans_over.pdparams', type=str,
#         help='snapshot of models to eval')
