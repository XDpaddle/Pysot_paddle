...
__C.DATASET.VID.ROOT = 'train_dataset_vid\\vid\\crop511'
__C.DATASET.VID.ANNO = 'train_dataset_vid\\vid\\train.json'
...
__C.FUSION.TYPE = 'aa'
__C.FUSION.num_encoders = 2
__C.FUSION.num_decoders = 1
__C.FUSION.dim = 256
__C.FUSION.num_heads = 8
__C.FUSION.mlp_ratio = 4
__C.FUSION.qkv_bias = True
__C.FUSION.drop_rate = 0
__C.FUSION.attn_drop_rate = 0
...
__C.HP_SEARCH.SatSOT = [0.33, 0.04, 0.3]
